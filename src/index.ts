...
/**
 * Restores the original WebSocket send function.
 ...
 * @function fixDeafenState
 * @param {HTMLButtonElement} deafenButton The deafen button to fix.
 * @param {HTMLButtonElement} [muteButton] The mute button to fix, if it exists.
 */
function fixDeafenState (deafenButton: HTMLButtonElement, muteButton?: HTMLButtonElement) {
  setTimeout(() => {
...
/**
 * This function retrieves the necessary elements from the Discord UI and applies the appropriate classes to the fake deafen button and its child elements to ensure consistent styling with the existing voice control buttons.
 ...
 */
function assignStyles (button: HTMLButtonElement, childDiv: HTMLDivElement, childDivChild: HTMLDivElement): void {
 ...
 * @returns {HTMLElement}
 */
function getControlPanel (): HTMLElement {
 ...
 */
function getVoiceControls (vcControlPanel: HTMLElement): HTMLDivElement {
 ...
 */
function getMuteButton (voiceControls: HTMLDivElement): HTMLButtonElement {
  if (!voiceControls || !(voiceControls instanceof HTMLDivElement))
    throw new Error('Voice Controls not found');
 ...
 */
function getSettingsButtonClasses (voiceControls: HTMLDivElement): { buttonClasses: string[], childDivClasses: string[], childDivsChildClasses: string[]; } {
 ...
 */
function createSpyIcon (): SVGSVGElement {
 ...
 */
function createFakeDeafenButton (): void {
...
/**
 * Exports the plugin's main functionality.
 * @module Discord-Fake-Deafen
 */
module.exports = () => {
  return {
    start: () => {
